...
<body>
    ...
    if($result->num_rows > 0) {
        ...
        <div class="card-body"><img class="float-left" src="assets/img/ct_icon.png" style="width:125px;margin-left:115px;">
            <h1 class="float-left text-center" style="font-size:50px;margin-bottom:0px;margin-top:25px;width:650px;"><strong style="color:rgb(91,118,141);">'.$row["team_2"].'</strong>:<strong style="color:rgb(172,155,102);">'.$row["team_3"].'</strong></h1><img class="float-right" src="assets/img/t_icon.png" style="width:125px;margin-bottom:5px;margin-right:115px;">
            <div class="clear"></div>
